...
def main():
    ...
    for machine_num in range(machine_count):
        ...
        a_presses = round(button_presses[0,0], 5)
        b_presses = round(button_presses[1,0], 5)
        if math.floor(a_presses) == a_presses and math.floor(b_presses) == b_presses and (0 <= a_presses, b_presses <= 100):
